...
Awesome images for [security](https://github.com/carpedm20/awesome-hacking#docker-images-for-penetration-testing--security) and [Ansible](https://github.com/ArtiomL/f5-ansible).
